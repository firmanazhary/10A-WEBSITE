...
export default function MomenPenting () {
    return (
        <section className="w-full px-5 py-10 relative flex flex-col h-auto">
          <h1 className="text-6xl font-bold mb-5 text-center font-vietnam text-white">Momen-momen Penting</h1>
...
></div>
          <div className="grid grid-cols-4 grid-rows-2 gap-10 z-20 mx-10">
            <div className="row-start-1 col-start-1 row-end-2 col-end-2 h-24 rounded-xl shadow flex flex-col items-center">
              <div className="w-72 flex justify-center items-center">
                <img src={Gambar} alt="" className="grayscale"/>
              </div>
              <div className="w-72 h-auto mt-2 items-center flex flex-col">
                <p className="font-vietnam text-2xl text-white"><span className="font-bold">Telaga Pelangi - </span>Jalan-jalan ke wisata Telaga Pelangi Payang</p>
                <div className="flex flex-row items-start gap-5 mt-2 justify-start">
