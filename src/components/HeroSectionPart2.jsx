...
export default function HeroSectionPart2() {
    ...
    <section className="flex flex-col">
        <div className="w-full h-auto flex flex-col lg:pl-5 md:pl-4 lg:pr-5  md:pr-4 lg:-mt-[70px]">
            ...
            {/* text zenthoria yang buat mobile */}
             ...
             <div className="flex justify-center lg:-mt-[420px] max-sm:hidden md:-mt-[270px] md:px-10 ">
                <img src={gambar2} alt="" className="lg:w-[320px] lg:h-[320px] rounded-[20px] lg:mt-40 -rotate-12 -mr-20 md:w-[270px] md:-mr-10 md:h-[270px] md:mt-40 hover:scale-105 transform duration-500 transition ease-in-out hover:z-20"/>

                <div className="lg:w-[400px] bg-white rounded-[40px] flex flex-col items-center relative pb-10 md:w-[300px] z-10 md:h-[400px] lg:h-[520px] hover:scale-105 transform duration-500 transition ease-in-out">
                ...
                <img src={gambar3} alt="" className="lg:w-[320px] lg:h-[320px] rounded-[20px] mt-[170px] rotate-[20deg] -ml-16 md:w-[270px] md:-ml-10 md:h-[270px] hover:scale-105 transform duration-500 transition ease-in-out hover:z-20"/>
             </div>
