...
export default function HeroSectionPart2() {
    return( 
    <section className="">
        <div className="pl-[62px] pt-[30px]">
            <h1 className="font-vietnam text-white font-bold text-[9vh]">WE ARE</h1>
        </div>
        <div className="font-vietnam text-[195px] text-white font-bold flex justify-between items-center px-[62px] -mt-[30px]">
            <h1 className="text-[27vh]">ZEN</h1>
            ...
            <h1 className="text-[27vh]">THORIA</h1>
        </div>
    </section>)
}