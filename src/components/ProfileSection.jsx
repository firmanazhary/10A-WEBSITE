          ...
          {studentsData
            ...
            .map((student) => (
              <motion.div
                ...
                viewport={{ once: true }}
                // whileHover={{ y: -10 }}
                className="hover:z-40 flex flex-col justify-start bg-gray-800 shadow-xl hover:shadow-sm hover:shadow-white rounded-xl overflow-hidden hover:scale-110 transition-all hover:-translate-y-2 duration-300">
